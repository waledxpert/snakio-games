...
const MOTIFS = {
  ...
  duel(ctx, w, h, cellPx, p) {
    ...
    b.forEach(([gx, gy], i) => {
      ctx.fillStyle = i % 2 ? "#ff5a5a" : "#c0392b";
      ctx.fillRect(gx * cellPx + 2, gy * cellPx + 2, cellPx - 4, cellPx - 4);
    });
  },
  maze(ctx, w, h, cellPx, p) {
    ...
    walls.forEach(([c, r, cw, ch]) =>
      ctx.fillRect(c * cellPx, r * cellPx, cw * cellPx, ch * cellPx),
    );
    ctx.fillStyle = p.snakeA;
      ...
      <div className="games-grid">
        ...
        >
          ...
          <div className="game-body">
            ...
            <p className="game-blurb">
              Private 1v1 matches with separate boards, live score tracking, and
              winner resolution by mode.
            </p>
            <div className="game-foot">
